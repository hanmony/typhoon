...
- **codex 审查状态**：已审查，主题召回冒烟口径条件通过；答案证据级 7/9，Q7/Q8 留待后续补强
- **提交**：见 git 历史

### D7 codex 审查：分层命中口径与全量回溯（2026-08-18）
- **结论**：D7 作为检索链路主题召回冒烟测试条件通过：Q1–Q9 top5 均有对应主题，9/9；但答案证据级只有 Q1–Q6、Q9 共 7/9，Q7 未返回研究结论、Q8 未返回具体改进方法，不能把主题相关扩大解释成 9/9 均可直接支撑回答。
- **敏感口径**：Q10 未命中值班表、手机号、身份证、邮箱或实际联系方式；“通讯录/联络员”只是制度要求。起草人「耿凯亮」经原文确认是公开署名/修订元数据，不属于本项目红线，但姓名仍是个人信息，报告已去掉笼统“非敏感”的绝对说法。
